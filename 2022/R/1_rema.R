# Run random effects model present models 20 (base) and 22 (new)
...
saveRDS(m22_sst, here::here("2022", "results", "m22_sst.rds"))
...
saveRDS(m22_nonsst, here::here("2022", "results", "m22_nonsst.rds"))
