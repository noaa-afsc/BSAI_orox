...
source("2020/R/admb_helper.R") # read in admb output
source("2020/R/re_helper.R") # generalizes running random effects model
...
if(!file.exists("RE.exe")) {
  # Sys.setenv(ADMB_HOME = "c:/admb") # version 12.2
  # Sys.setenv(ADMB_HOME = "C:/ADMB-13.0")
  setup_admb()
